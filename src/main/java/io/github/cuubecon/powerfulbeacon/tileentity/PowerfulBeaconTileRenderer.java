...
public class PowerfulBeaconTileRenderer extends TileEntityRenderer<PowerfulBeaconTile>
{
    public static final ResourceLocation BEAM_LOCATION = new ResourceLocation("textures/entity/beacon_beam.png");

    public PowerfulBeaconTileRenderer(TileEntityRendererDispatcher p_i226003_1_) {
        super(p_i226003_1_);
    }
    ...
    public void render(PowerfulBeaconTile p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
        ...
        for(int k = 0; k < list.size(); ++k) {
            ...
            renderBeaconBeam(p_225616_3_, p_225616_4_, p_225616_2_, i, j, k == list.size() - 1 && p_225616_1_.isAir(beacontileentity$beamsegment.getPosY()) ? 1024 : beacontileentity$beamsegment.getHeight(), beacontileentity$beamsegment.getColor());
    ...
    @Override
    public boolean shouldRenderOffScreen(PowerfulBeaconTile p_188185_1_) {
        return true;
    }
}
